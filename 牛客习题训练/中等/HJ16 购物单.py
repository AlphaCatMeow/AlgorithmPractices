...
他希望在花费不超过 N 元的前提下，使自己的满意度达到最大。满意度是指所购买的每件物品的价格与重要度的乘积的总和，
假设设第ii件物品的价格为：v[i]，重要度为：w[i]，共选中了 k 件物品，编号依次为：j1,j2,...,jk，
则满意度为：v[j1]*w[j1],v[j2]*w[j2],...,v[jk]*w[jk]。请你帮助王强计算可获得的最大的满意度。
...
"""
"""
思路见：https://blog.nowcoder.net/n/82b5f014a8654c8b8dbff4fe4fa727bd
"""
